...
function AdminMovieSection() {
  ...
  const handleRemoveCategoryFormSubmit = (
    event,
    needValidation,
    url,
    method,
  ...
  const searchMovie = async (movieName) => {
    axios
      .get(`${urlPattern}/api/movies/search/${movieName}/`)
      .then((response) => {
  ...
  useEffect(() => {
    axios
      .get(`${urlPattern}/api/movies?page=${currentPage}`)
      .then((response) => {
  ...
  return (
    <div className="adminMovieSection">
      ...
      <div className="row movieSection gap-4">
        ...
        <div className="right col-4">
          ...
          <button
            ...
            onClick={() =>
              handleShowModal(categoryRemoveModalRef, "Remove Category")
            }
          >
            Remove Category
                ...
                >
                  ...
                  {[1, 2].map((num) => (
                    <div className="col-md-6" key={`image${num}`}>
                      <label htmlFor={`image${num}`} className="form-label">
                        Image {num}
                      </label>
                      <input
                        type="file"
                  ...
                  <div className="col-md-12">
                    <label htmlFor="movieTrailer" className="form-label">
                      Movie Trailer Link
                    </label>
                    <input
                      type="text"
                    ...
                    />
                    <div className="invalid-feedback">
                      Please enter a valid movie Trailer Link.
                    </div>
                  </div>
      ...
      <CategoryModel
        ...
        buttonClass="primary"
        categoryModalRef={categoryAddModalRef}
      ...
      <CategoryModel
        ...
        buttonClass="danger"
        categoryModalRef={categoryRemoveModalRef}
        modelTitle={"Remove Category"}
        id="removeCategoryModal"
        url={`/api/genres/delete-genres/${encodeURIComponent(
          inputs.category,
        )}/`}
        formBody={
          <div className="col-12">
          ...
          <div className="modal-dialog modal-lg modal-dialog-centered">
            <div className="modal-content shadow-lg border-0 rounded-3">
              <div className="modal-header border-0">
                <h1 className="modal-title fs-4 fw-bold" id="imageEnlargeLabel">
                  Enlarged Image
                </h1>
                <button
                  type="button"
                ...
                >
                  <div className="carousel-inner">
                    ...
                    <div className="carousel-item active">
                      <img
                        src={enlargedImage[0]}
                        className="d-block w-100 img-fluid rounded-3 shadow-lg"
                        alt="Image 1"
                      />
                    </div>
                    {/* Image 2 */}
